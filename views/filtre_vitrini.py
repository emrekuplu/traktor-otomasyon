...
class FiltreVitrini(QWidget):
    ...
    def __init__(self, go_back, on_filtre_sec, parent=None):
        ...
        # ── Filtre Kartları ───────────────────────────────────────────────────
        filtreler = [
            ("Hava Filtresi", "Motor ve kabin içi hava akış sistemleri", "resources/icons/filters/air_filter.png"),
            ("Yağ Filtresi", "Motor karter ve şanzıman yağ filtreleri", "resources/icons/filters/oil_filter.png"),
            ("Mazot Filtresi", "Yakıt enjeksiyon ve ayırıcı filtreler", "resources/icons/filters/fuel_filter.png"),
            ("Hidrolik Filtresi", "Hidrolik lift ve sistem filtreleri", "resources/icons/filters/hydraulic_filter.png")
        ]
